...
public interface ContactsRepository extends JpaRepository<Contact, Integer> {
    ...
    Page<Contact> findByStatus(@Param("status") String status, Pageable pageable); //If you want to use :parameter style and you want the method parameter to match the name in the query, you need the @Param annotation to prevent ambiguity
